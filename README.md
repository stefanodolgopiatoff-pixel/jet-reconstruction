...
Then the model's performance is evaluated through visualization of training and validation accuracy/loss curves, generation of a comprehensive classification report detailing precision, recall, and F1-score for each class, and a confusion matrix. 
...
**TO NOTE**
I used T4 GPU on Google Colab to optimize the training speed, with CPU the time needed increases.

**DATASET**
The original dataset can be found at this link: https://www.kaggle.com/datasets/brsdincer/proton-collision-image-set?select=Proton+Collision+13TeV .
